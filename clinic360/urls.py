...
urlpatterns = [
    ...
    path('api/schema/', SpectacularAPIView.as_view(), name='schema'),  # The OpenAPI schema
    path('api/docs/', SpectacularSwaggerView.as_view(url_name='schema'), name='swagger-ui'),  # The Swagger UI
]
